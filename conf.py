...
BLOG_AUTHOR = "Hungara Esperanto-Junularo"  # (translatable)
BLOG_TITLE = {'eo': "La freneza JER 2016", 'hu': "A bolond JER 2016"}  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://jer.hu/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://jer.hu/"
BLOG_EMAIL = "jes@jes.hu"
BLOG_DESCRIPTION = {'eo': "La freneza JER", 'hu': "A bolond JER"}  # (translatable)
...
# (translatable)
CONTENT_FOOTER = 'Enhavo &copy; {date}         <a href="mailto:{email}">{author}</a> - Kreita per         <a href="https://getnikola.com" rel="nofollow">Nikola</a>         {license}'
...
MARKDOWN_EXTENSIONS = ['fenced_code', 'codehilite', 'extra', 'tables']
...
BIOGRAPHY = """
<img style="float:left;margin:10px 20px 10px 0px;max-height:200px;" src="http://1.bp.blogspot.com/-NOwIDhwSZ00/TZZDslB2CkI/AAAAAAAABCg/-XhSU29TJyI/s150/hej_logo-sotetzold-fekete.jpg">
<p>La <b>Hungara Esperanto-Junularo</b>, mallongigite <b>HEJ</b> (hungare: <b>MIESZ</b>,  Magyar Ifjúsági Eszperantó Szövetség) estas asocio por  Esperanto-parolantaj hungaraj junuloj. HEJ fariĝis kiel memstara asocio  en 1990, eksiĝinte el la Hungaria Esperanto-Asocio.</p>
<p>Ĝia plej grava celo estasebligi la membrojn por aliĝi en la hejmlandan kaj internacian Esperanto-vivon.</p>
<ul>
<li>· satigi la proprajn bezonojn de la Esperanto-parolantaj junuloj</li>
<li>· reprezenti la interesojn ĉe aliaj organizoj kaj institucioj</li>
<li>· reprezenti la membrojn al hungaraj (OGYIP, NIOK) kaj internaciaj (<a class="ext" href="http://eo.wikipedia.org/wiki/TEJO" target="_blank" title="TEJO">TEJO</a><span class="ext"></span>, <a class="ext" href="http://eo.wikipedia.org/wiki/UEA" target="_blank" title="UEA">UEA</a><span class="ext"></span>) ombrel-organizoj</li>
<li>· klerigi junularajn gvidantojn</li>
<li>· kunlabori kun ne-esperantistaj organizaĵoj por komunaj celoj de la junularo.&nbsp;</li>
</ul>
"""
...
GLOBAL_CONTEXT = {
    ...
    'social_links': [
        ...
        {
            "url": "https://twitter.com/IJSenHungario",
            "bgcolor": "#55ACEE",
            "color": "#fffff",
